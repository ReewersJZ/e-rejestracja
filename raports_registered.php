...
// Pobieranie listy umówionych wizyt - dla przychodni o id pasującym do pracownika który w niej pracuje
...
$date_from = $_POST['raports_registered_date_from'];
$date_to = $_POST['raports_registered_date_to'];
$clinic_id = $_POST['raports_registered_clinic_id'];
...
if(isset($date_from) && $date_from != "" && isset($date_to) && $date_to != ""){
    ...
    $raports_term->getBookedTermsRaports($date_from, $date_to, $clinic_id, "zajety", "");
    ...
    if($raports_term->getError()){
        ...
        if(count($raports_term->raports_booked_terms_array) > 0){
            ...
            $block_info_array = "<h5>Zarejestrowani pacjenci:</h5>";
